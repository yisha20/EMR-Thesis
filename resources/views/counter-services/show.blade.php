...
<div class="dashboard-wrap counter-service-workspace">
    ...
    <section class="dashboard-panel mt-3">
        ...
        <form method="POST" action="{{ route('counter-services.complete', $queue) }}" class="workflow-form workflow-form-grid" data-counter-form="service">
            ...
            <div><button type="button" class="btn btn-light" data-save-counter-draft>Save Draft</button> <button class="btn btn-primary" data-submit-loading="Completing...">Complete Counter Service</button> <small data-counter-draft-status class="text-muted"></small></div>
        </form>
